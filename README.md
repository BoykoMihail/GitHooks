...
![Hook Image 1](Images/hook_1.png =150x150)
...
![Hook Image 2](Images/hook_2.png =150x150)
...
GUI-клиент: В этом случае происходит коммит и текст не меняется.
![Hook Image 3](Images/hook_3.png =150x150)
...
![Hook Image 4](Images/hook_4.png =150x150)
...
GUI-клиент: В этом случае происходит коммит с текстом в формате "[WITHOUT ISSUE]: text".
![Hook Image 5](Images/hook_5.png =150x150)
